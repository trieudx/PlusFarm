...
// ieee80211_ets.o
struct esf_buf *sdk_ieee80211_getmgtframe(void **arg0, uint32_t arg1,
                                          uint32_t arg2);
...
// ieee80211_input.o
void sdk_ieee80211_deliver_data(struct sdk_g_ic_netif_info *netif_info,
                                struct esf_buf *esf_buf);
...
struct esf_buf *sdk_ieee80211_beacon_alloc(struct sdk_g_ic_netif_info *,
                                           uint32_t *);
...
void sdk_cnx_node_leave(struct sdk_g_ic_netif_info *netif,
                        struct sdk_netif_conninfo *conn);
