...
__attribute__((weak)) long _write_stdout_r(struct _reent *r, int fd,
...
__attribute__((weak)) long _write_filesystem_r(struct _reent *r, int fd,
                                               const char *ptr, int len)
{
  r->_errno = EBADF;
  return -1;
...
__attribute__((weak)) long _write_r(struct _reent *r, int fd, const char *ptr,
                                    int len)
{
...
__attribute__((weak)) long _read_stdin_r(struct _reent *r, int fd, char *ptr,
                                         int len)
{
  int ch, i;
...
/* default implementation, replace in a filesystem */
__attribute__((weak)) long _read_filesystem_r(struct _reent *r, int fd,
                                              char *ptr, int len)
{
  r->_errno = EBADF;
  return -1;
...
__attribute__((weak, alias("syscall_returns_enosys"))) 
 off_t _lseek_r(
    struct _reent *r, int fd, off_t offset, int whence);
