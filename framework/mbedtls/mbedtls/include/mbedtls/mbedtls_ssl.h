...
#include "mbedtls_ecp.h"

#include "mbedtls_ssl_ciphersuites.h"

#if defined(MBEDTLS_X509_CRT_PARSE_C)
#include "mbedtls_x509_crt.h"
#include "mbedtls_x509_crl.h"
#endif

#if defined(MBEDTLS_DHM_C)
#include "mbedtls_dhm.h"
#endif

#if defined(MBEDTLS_ECDH_C)
#include "mbedtls_ecdh.h"
#endif

#if defined(MBEDTLS_ZLIB_SUPPORT)
#include "mbedtls_zlib.h"
#endif
...
#define MBEDTLS_SSL_CHANNEL_INBOUND     1
  ...
  void mbedtls_ssl_set_bio(
      mbedtls_ssl_context *ssl, void *p_bio,
      int (*f_send)(void *, const unsigned char *, size_t),
      int (*f_recv)(void *, unsigned char *, size_t),
      int (*f_recv_timeout)(void *, unsigned char *, size_t, uint32_t));
  ...
  void mbedtls_ssl_set_timer_cb(
      mbedtls_ssl_context *ssl, void *p_timer,
